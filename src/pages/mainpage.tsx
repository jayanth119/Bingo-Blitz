...
import { logout , db } from '../utils/firebase.ts';
    ...
    if (isCorrect && selectedCell !== null) {
      ...
      if (currentQuestion) {
        const responseDoc = {
          ...
          userSelectedOption: selectedCell, 
          score: pointsEarned,
        };
  
        try {
          await setDoc(doc(db, "users", "USER_ID", "responses", currentQuestion.id), responseDoc);
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 to-purple-900 text-white">
      <header className="p-4 flex justify-between items-center border-b border-indigo-700">
        ...
        <div className="flex items-center gap-4">
         ...
         <button
                        onClick={logout}
                        className="mt-4 bg-red-500 p-2 rounded hover:bg-red-600"
                    >
                        Logout
                    </button>
        </div>
